...
It's a very cheap alternative *OMDAZZ dev board* (approx. 40 €) to the very expensive ones, 
but the FPGA is a dated Cyclone IV, with not so many logic cells. 
It's perfect for hobby-related projects, but not for more intensive operations.
I suggest to follow this series of projects and contatct me if anything is wrong or not clear. 
